...
const PANEL_IDS = ['d-ai_config', 'd-connections', 'd-formatting', 'd-world_info', 'd-settings', 'd-backgrounds', 'd-extensions', 'd-persona', 'd-characters', 'd-card_editor', 'd-groups' /* w3-grp */];
