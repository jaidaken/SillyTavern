...
const char_store = @import("../cast/character_store.zig"); // w3-chatref: group rows resolve avatars by name
const group_store = @import("../cast/group_store.zig"); // w3-chatref
