...
const pager = @import("../chat/pager.zig"); // w3-wi-engine: the one full-token owner
...
pub const position_options: []const @import("../nav/dropdown_nav.zig").Option = &.{
    .{ .value = "2", .label = "Before the card" },
    .{ .value = "0", .label = "After the card" },
    .{ .value = "1", .label = "In the chat" },
};

pub const role_options: []const @import("../nav/dropdown_nav.zig").Option = &.{
