...
const sampler_presets = @import("../setup/sampler_presets.zig");
const nav = @import("../nav/dropdown_nav.zig");
const generate = @import("../setup/generate.zig");
const conn_mod = @import("../setup/connection.zig");
...
pub const names_options: []const @import("../nav/dropdown_nav.zig").Option = &.{
